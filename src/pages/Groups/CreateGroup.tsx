            ...
            <Jumbotron fluid>
                <Container>
                    ...
                    <p className="lead">
                        ...
                        friends' wish lists. If you'd like to, you can add
                        people to your group here. You'll only be able to see
                        the emails of people who have access to use this app
                        already.
                    </p>
                    <p>
                        <em>
                            You will be made the owner of the group. So much
                            power!
                        </em>
                    </p>
                </Container>
                        ...
                        <Form noValidate>
                            ...
                            <Form.Group controlId="code">
                                ...
                                <Form.Text id="codeHelpText" muted>
                                    This could should be four or more
                                    letters/numbers that your friends can use to
                                    join your group. Don't forget it but don't
                            ...
                            <Form.Group controlId="isPublic">
                                ...
                                <Form.Check
                                    ...
                                    value="false"
                                    checked={
                                        groupForm.values.isPublic === false
                                    }
                                    onChange={handleRadioChange}
                                    disabled
                                />
                                <Form.Text id="isPublicHelpText" muted>
                                    Groups are set to private by default for
                                    now.
                                </Form.Text>
                            </Form.Group>
